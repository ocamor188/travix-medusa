...
import com.travix.medusa.service.BusyFlightsService;
...
public class BusyFlightsApiController {
	...
	public ResponseEntity<List<BusyFlightsResponse>> getFlights(@PathVariable("origin") String origin, @PathVariable("destination") String destination/*,
		...
		ResponseEntity<List<BusyFlightsResponse>> flightsFares = busyFlightsService.getFares(origin,destination,numberOfPass);
		return flightsFares;
	}
